...
// let getEvenNumbers = (arr) => arr.filter((n) => n % 2 == 0);
...
// let q3 = (array) => array.filter((i) => i > 0).reduce((a, b) => a + b);

// console.log(q3([1, 3, -5, 12, 4, -21, 3, -2]));
...
//   }
//   return `${binary.reduce((a, b) => a + b)} ${binary.join("")}`;
// };
